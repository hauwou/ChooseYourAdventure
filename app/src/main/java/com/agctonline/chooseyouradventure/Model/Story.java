...
/**
 * Created by admin on 11/21/2014.
 */
public class Story {

    private Page[] mPages;
    //create an array of Page class

    public Story() {
        //this is the default constructor for the class
        //it will automatically load up the data into the
        //mPages array

        mPages = new Page[7];

        //when calling the Page class with parameters,
        //the number of parameters will determine which
        //constructor to initialize
        //In this case, the Page class has 2 constructors
        //created, 1 with 2 params, and 1 with 4 params
